...
/// ----------------------------post data user dari register-----------------------------------
app.post('/api/users/register', upload.single('fotoKTP'), async (req, res) => {
  try {
...
/// --------------------------post data teknisi dari register-----------------------------------
app.post('/api/technicians/register', upload.single('fotoKTP'), async (req, res) => {
  try {
    const {
      nama,
      email,
