...
@Composable
fun UserOrderScreen(navController: NavController){
...
fun OrderScreenPreview(){
    UserOrderScreen(navController = rememberNavController())
}


@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@Composable
fun TechOrderScreen(navController: NavController){
    val pageTitle = "Order History"
    Scaffold(
        topBar = {
            ConstraintLayout {
...
@Preview(showBackground = true)
@Composable
fun TechOrderScreenPrview(){
    TechOrderScreen(navController = rememberNavController())
}